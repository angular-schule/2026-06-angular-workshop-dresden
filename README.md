...
> [!IMPORTANT]  
> **Bitte erledige die Vorbereitung rechtzeitig vor dem Kurs. Melde dich bei uns, wenn etwas nicht klappt.**
...
> [!IMPORTANT]  
> **Wir verwenden in diesem Workshop ausnahmsweise eine `next`-Version von Angular. Die neue Major-Version Angular 22.0 erscheint voraussichtlich am 3. Juni 2026 – während unseres Workshops.**

```bash
npx @angular/cli@next new book-rating --style=scss --no-ssr
```
...
Sollte es zu einer Fehlermeldung kommen, dann sende uns den Fehlertext einfach per Mail an [team@angular.schule](mailto:team@angular.schule) oder bring deine Fragen zum Technikcheck mit.

<hr>

<img src="https://assets.angular.schule/logo-angular-schule.png" height="60">

### &copy; https://angular.schule | Stand: 14.05.2026
